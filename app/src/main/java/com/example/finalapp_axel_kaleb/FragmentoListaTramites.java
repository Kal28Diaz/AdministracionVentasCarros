...
public class FragmentoListaTramites extends Fragment {

    private RecyclerView mRecyclerView;
    private TextView mTextView;
    private TramitesAdapter mAdaptador;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragmento_lista_tramites, container, false);
        mRecyclerView = view.findViewById(R.id.recycler_view_tramites);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        mTextView = view.findViewById(R.id.alerta_tramites);
        updateUI();
        return view;
    }
    ...
    private void updateUI() {
        ...
        if(mAdaptador == null){
            mAdaptador = new FragmentoListaTramites.TramitesAdapter(tramites);    //El adaptador recibe la lista de tramites
    ...
    private class TramitesHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            Intent intent = ActividadCliente.newIntent(getActivity(), mTramite.getmID(), false);
    ...
    //Adaptador
    private class TramitesAdapter extends RecyclerView.Adapter<FragmentoListaTramites.TramitesHolder> {
        ...
        @NonNull
        @Override
        public FragmentoListaTramites.TramitesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = LayoutInflater.from(getActivity());
            return new FragmentoListaTramites.TramitesHolder(layoutInflater, parent);
        }

        @Override
        public void onBindViewHolder(@NonNull FragmentoListaTramites.TramitesHolder holder, int position) {
